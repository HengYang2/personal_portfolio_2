    ...
    <div>
      ...
      >
        <MenuItem onClick={() => handleButtonClick('Button 1')}>
          <Button variant='contained' color='secondary' onClick={() => { setViewState('projectView'); cameraTween(props.camera, props.target, 'trophies', setIsTweenFinished); }}>
            Projects
          </Button>
        </MenuItem>
        <MenuItem onClick={() => handleButtonClick('Button 2')}>
          <Button variant='contained' color='secondary' onClick={() => { setViewState('techStackView'); cameraTween(props.camera, props.target, 'books', setIsTweenFinished); }}>
            Tech Stack
          </Button>
        </MenuItem>
      </Menu>
