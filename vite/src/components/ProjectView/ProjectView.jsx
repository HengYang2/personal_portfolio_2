...
export default function ProjectView() {
  ...
  return (
    <Container maxWidth={false} sx={{ padding: '0%', bgcolor: '', height: '100%', position: 'absolute', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      <Container sx={{ bgcolor: "", height: "25%", width: '100%', paddingLeft: { mobile: '3%', tablet: '3%', laptop: '12%', desktop: '12%' }, paddingRight: { mobile: '5%', tablet: '5%', laptop: '12%', desktop: '12%' }, marginBottom: { mobile: '5%', tablet: '5%', laptop: '3%', desktop: '2%' } }}>
        <Paper sx={{ height: '100%', margin: '0%', padding: '3%' }}>THIS IS PROJECT VIEW</Paper>
      </Container>
    </Container>
  )
}
