export default function responseModule(selectedQuestion) {
    ...
    switch (selectedQuestion) {
        case 'AB0':
            return ({
                dialogSequence: ["What are you doing inside my room?!! ... Well since you're already here, I'll answer any questions that you may have for me."],
                isFollowUpQuestion: true,
                followUpQuestionCode: null,
            });
        case 'AB1':
            return ({
                dialogSequence: ["My name is Heng Yang, I'm a software developer who enjoys creating games, making music, and any kind of creative expression :^)", "I like building things, for example this world you see here! I guess you can say that you're looking into a part of my mind right now!", 'Do you have any other questions?'],
                isFollowUpQuestion: true,
                followUpQuestionCode: null,
            });
        case 'AB2':
            return ({
                dialogSequence: ['Why, in my room silly, hehe...', 'But on a more serious note, this is my personal portfolio, where you can interact with my room to learn more about me. :^)', 'Take a look at my shelf to see my other projects and tech stack!', 'Do you have any other questions?'],
                isFollowUpQuestion: true,
                followUpQuestionCode: null,
            });
        case 'AB3':
            return ({
                dialogSequence: ['Besides coding, I enjoy 3d modeling in blender - As you can see by my beautiful mustachio ;)', 'I also enjoy creating music on FL-Studio and spending time with friends and family. :)', 'When I feel like thinking, I code. When I feel like building something, I create in blender. When I want to hear something new, I make music! Three different mediums, but they all fulfill my desire to create!', 'Do you have any other questions?'],
                isFollowUpQuestion: true,
                followUpQuestionCode: null,
            });
        case 'AB4':
            return ({
                dialogSequence: ["How may I help you?"],
                isFollowUpQuestion: true,
                followUpQuestionCode: null,
            });
        ...
        case 'PJ0':
            return ({
                dialogSequence: ['These are my projects that I have worked on in the past or am currently working on!', 'Try hovering over each trophy for a cool animation! Click on a trophy to learn more about that specific project!'],
        ...
        case 'REDUX / SAGAS':
            return ({
                dialogSequence: reduxSagasStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'JAVASCRIPT':
            return ({
                dialogSequence: javascriptStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'JQUERY':
            return ({
                dialogSequence: jqueryStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'NODE.JS':
            return ({
                dialogSequence: nodejsStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'GIT / GITHUB':
            return ({
                dialogSequence: gitStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'SQL':
            return ({
                dialogSequence: sqlStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'POSTGRES':
            return ({
                dialogSequence: postgresStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'HOSTINGER':
            return ({
                dialogSequence: hostingerStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'AWS':
            return ({
                dialogSequence: awsStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'MATERIAL UI':
            return ({
                dialogSequence: muiStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        case 'THREE.JS':
            return ({
                dialogSequence: threeJsStory,
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
        ...
        case 'M0':
            return ({
                dialogSequence: ["This is my BOOM-BOX! Isn't it lovely? I made it myself!", 'You can interact with the audio-track interface to listen to music composed by yours truly! :^)'],
                isFollowUpQuestion: false,
                followUpQuestionCode: null,
            });
